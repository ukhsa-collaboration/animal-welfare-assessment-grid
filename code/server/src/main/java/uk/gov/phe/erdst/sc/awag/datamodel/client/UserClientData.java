...
public class UserClientData
{
    ...
    @Size(min = ValidationConstants.USER_NAME_SIZE_MIN,
        max = ValidationConstants.USER_NAME_SIZE_MAX, message = ValidationConstants.USER_NAME_PROPERTY + "|"
            + ValidationConstants.USER_NAME_SIZE_MIN + "|" + ValidationConstants.USER_NAME_SIZE_MAX,
