...
public class SpeciesClientData
{
    ...
    @NotNull(message = ValidationConstants.SPECIES_NAME_PROPERTY,
        payload = ValidationConstants.PropertyMustBeProvided.class)
    @Size(min = ValidationConstants.SPECIES_NAME_SIZE_MIN,
        max = ValidationConstants.SPECIES_NAME_SIZE_MAX, message = ValidationConstants.SPECIES_NAME_PROPERTY + "|"
            + ValidationConstants.SPECIES_NAME_SIZE_MIN + "|" + ValidationConstants.SPECIES_NAME_SIZE_MAX,
