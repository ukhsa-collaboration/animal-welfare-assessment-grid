...
public class AssessmentTemplateClientData
{
    ...
    @NotNull(message = ValidationConstants.TEMPLATE_NAME_PROPERTY,
        payload = ValidationConstants.PropertyMustBeProvided.class)
    @Size(min = ValidationConstants.TEMPLATE_NAME_SIZE_MIN, max = ValidationConstants.TEMPLATE_NAME_SIZE_MAX,
        message = ValidationConstants.TEMPLATE_NAME_PROPERTY + "|" + ValidationConstants.TEMPLATE_NAME_SIZE_MIN + "|"
            + ValidationConstants.TEMPLATE_NAME_SIZE_MAX,
