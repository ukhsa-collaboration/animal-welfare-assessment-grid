...
public class AssessmentReasonClientData
{
    ...
    @NotNull(message = ValidationConstants.REASON_NAME_PROPERTY,
        payload = ValidationConstants.PropertyMustBeProvided.class)
    @Size(min = ValidationConstants.REASON_NAME_SIZE_MIN, max = ValidationConstants.REASON_NAME_SIZE_MAX,
        message = ValidationConstants.REASON_NAME_PROPERTY + "|" + ValidationConstants.REASON_NAME_SIZE_MIN + "|"
            + ValidationConstants.REASON_NAME_SIZE_MAX,
    ...
    public AssessmentReasonClientData()
    {
    }
