...
public class SourceClientData
{
    ...
    @NotNull(message = ValidationConstants.SOURCE_NAME_PROPERTY,
        payload = ValidationConstants.PropertyMustBeProvided.class)
    @Size(min = ValidationConstants.SOURCE_NAME_SIZE_MIN,
        max = ValidationConstants.SOURCE_NAME_SIZE_MAX, message = ValidationConstants.SOURCE_NAME_PROPERTY + "|"
            + ValidationConstants.SOURCE_NAME_SIZE_MIN + "|" + ValidationConstants.SOURCE_NAME_SIZE_MAX,
