...
public class AnimalClientData
{
    ...
    @NotNull(message = ValidationConstants.ANIMAL_NUMBER_PROPERTY,
        payload = ValidationConstants.PropertyMustBeProvided.class)
    @Size(min = ValidationConstants.ANIMAL_NO_SIZE_MIN,
        max = ValidationConstants.ANIMAL_NO_SIZE_MAX, message = ValidationConstants.ANIMAL_NUMBER_PROPERTY + "|"
            + ValidationConstants.ANIMAL_NO_SIZE_MIN + "|" + ValidationConstants.ANIMAL_NO_SIZE_MAX,
