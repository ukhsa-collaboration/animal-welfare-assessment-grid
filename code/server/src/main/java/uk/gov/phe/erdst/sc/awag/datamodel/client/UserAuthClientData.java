...
public class UserAuthClientData
{
    ...
    @Size(min = ValidationConstants.AUTH_USER_NAME_SIZE_MIN,
        max = ValidationConstants.AUTH_USER_NAME_SIZE_MAX, message = ValidationConstants.AUTH_USER_NAME_PROPERTY + "|"
            + ValidationConstants.AUTH_USER_NAME_SIZE_MIN + "|" + ValidationConstants.AUTH_USER_NAME_SIZE_MAX,
    ...
    @NotNull(message = ValidationConstants.AUTH_PASSWORD_PROPERTY,
        payload = ValidationConstants.PropertyMustBeProvided.class)
    @Size(min = ValidationConstants.AUTH_PASSWORD_SIZE_MIN,
        max = ValidationConstants.AUTH_PASSWORD_SIZE_MAX, message = ValidationConstants.AUTH_PASSWORD_PROPERTY + "|"
            + ValidationConstants.AUTH_PASSWORD_SIZE_MIN + "|" + ValidationConstants.AUTH_PASSWORD_SIZE_MAX,
        payload = ValidationConstants.TextSizeLimits.class)
    ...
    @NotNull(message = ValidationConstants.AUTH_RETYPED_PASSWORD_PROPERTY,
        payload = ValidationConstants.PropertyMustBeProvided.class)
    @Size(min = ValidationConstants.AUTH_PASSWORD_SIZE_MIN,
        max = ValidationConstants.AUTH_PASSWORD_SIZE_MAX, message = ValidationConstants.AUTH_RETYPED_PASSWORD_PROPERTY
            + "|" + ValidationConstants.AUTH_PASSWORD_SIZE_MIN + "|" + ValidationConstants.AUTH_PASSWORD_SIZE_MAX,
        payload = ValidationConstants.TextSizeLimits.class)
    ...
    @NotNull(message = ValidationConstants.AUTH_GROUP_PROPERTY,
        payload = ValidationConstants.PropertyMustBeProvided.class)
    @Size(min = ValidationConstants.AUTH_GROUP_SIZE_MIN,
        max = ValidationConstants.AUTH_GROUP_SIZE_MAX, message = ValidationConstants.AUTH_GROUP_PROPERTY + "|"
            + ValidationConstants.AUTH_GROUP_SIZE_MIN + "|" + ValidationConstants.AUTH_GROUP_SIZE_MAX,
        payload = ValidationConstants.TextSizeLimits.class)
