...
public class FactorClientData
{
    ...
    @NotNull(message = ValidationConstants.FACTOR_NAME_PROPERTY,
        payload = ValidationConstants.PropertyMustBeProvided.class)
    @Size(min = ValidationConstants.FACTOR_NAME_SIZE_MIN,
        max = ValidationConstants.FACTOR_NAME_SIZE_MAX, message = ValidationConstants.FACTOR_NAME_PROPERTY + "|"
            + ValidationConstants.FACTOR_NAME_SIZE_MIN + "|" + ValidationConstants.FACTOR_NAME_SIZE_MAX,
    ...
    public FactorClientData(Long factorId, String factorName)
    {
