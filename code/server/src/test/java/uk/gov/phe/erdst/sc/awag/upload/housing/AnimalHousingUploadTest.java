package uk.gov.phe.erdst.sc.awag.upload.housing;
...
@Test(groups = {TestConstants.TESTNG_CONTAINER_TESTS_GROUP, TestConstants.TESTNG_CONTAINER_UPLOAD_TESTS_GROUP},
    priority = 1)
public class AnimalHousingUploadTest
{
    private static final long UPLOAD_ANIMAL_HOUSING_FILE_EXPECTED_VALID_LINE_COUNT = 3L;
    ...
    {
        FileInputStream fileInputStream = getTestDataFile("UploadAnimalHousing.csv");
        ...
        Assert.assertEquals(UPLOAD_ANIMAL_HOUSING_FILE_EXPECTED_VALID_LINE_COUNT, csvLines.size());
    ...
    {
        FileInputStream fileInputStream = getTestDataFile("UploadAnimalHousing_empty_file.csv");
    ...
    {
        FileInputStream fileInputStream = getTestDataFile("UploadAnimalHousing_failed_incorrect_columns.csv");
    ...
    {
        String testUploadAnimalHousingDataFile = TestConstants.UPLOAD_TEST_DATA_FOLDER + File.separator + "housing"
            + File.separator + testCSVDataFile;
        return new FileInputStream(testUploadAnimalHousingDataFile);
    }
}
