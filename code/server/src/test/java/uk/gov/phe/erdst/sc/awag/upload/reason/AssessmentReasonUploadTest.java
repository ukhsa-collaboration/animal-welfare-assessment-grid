...
@Test(groups = {TestConstants.TESTNG_CONTAINER_TESTS_GROUP, TestConstants.TESTNG_CONTAINER_UPLOAD_TESTS_GROUP},
    priority = 1)
public class AssessmentReasonUploadTest
{
    private static final long UPLOAD_REASON_FILE_EXPECTED_VALID_LINE_COUNT = 3L;
    ...
    {
        FileInputStream fileInputStream = getTestDataFile("UploadReason.csv");
        ...
        Assert.assertEquals(UPLOAD_REASON_FILE_EXPECTED_VALID_LINE_COUNT, csvLines.size());
    ...
    {
        FileInputStream fileInputStream = getTestDataFile("UploadReason_empty_file.csv");
    ...
    {
        FileInputStream fileInputStream = getTestDataFile("UploadReason_failed_incorrect_columns.csv");
    ...
    {
        String testUploadReasonDataFile = TestConstants.UPLOAD_TEST_DATA_FOLDER + File.separator + "reason"
            + File.separator + testCSVDataFile;
        return new FileInputStream(testUploadReasonDataFile);
    }
}
