package uk.gov.phe.erdst.sc.awag.upload.animal;
...
@Test(groups = {TestConstants.TESTNG_CONTAINER_TESTS_GROUP, TestConstants.TESTNG_CONTAINER_UPLOAD_TESTS_GROUP},
    priority = 1)
public class AnimalUploadTest
{
    private static final long UPLOAD_ANIMAL_FILE_EXPECTED_VALID_LINE_COUNT = 7L;
    ...
    {
        FileInputStream fileInputStream = getTestDataFile("UploadAnimal.csv");
        ...
        Assert.assertEquals(UPLOAD_ANIMAL_FILE_EXPECTED_VALID_LINE_COUNT, csvLines.size());
    ...
    {
        FileInputStream fileInputStream = getTestDataFile("UploadAnimal_empty_file.csv");
    ...
    {
        FileInputStream fileInputStream = getTestDataFile("UploadAnimal_failed_incorrect_columns.csv");
    ...
    */
    ...
    {
        String testUploadAnimalDataFile = TestConstants.UPLOAD_TEST_DATA_FOLDER + File.separator + "animal"
