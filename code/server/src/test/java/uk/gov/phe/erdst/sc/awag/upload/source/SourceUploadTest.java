package uk.gov.phe.erdst.sc.awag.upload.source;
...
@Test(groups = {TestConstants.TESTNG_CONTAINER_TESTS_GROUP, TestConstants.TESTNG_CONTAINER_UPLOAD_TESTS_GROUP},
    priority = 1)
public class SourceUploadTest
{
    private static final long UPLOAD_SOURCE_FILE_EXPECTED_VALID_LINE_COUNT = 3L;
    ...
    {
        FileInputStream fileInputStream = getTestDataFile("UploadSource.csv");
        ...
        Assert.assertEquals(UPLOAD_SOURCE_FILE_EXPECTED_VALID_LINE_COUNT, csvLines.size());
    ...
    {
        FileInputStream fileInputStream = getTestDataFile("UploadSource_empty_file.csv");
    ...
    {
        FileInputStream fileInputStream = getTestDataFile("UploadSource_failed_incorrect_columns.csv");
    ...
    private FileInputStream getTestDataFile(final String testCSVDataFile) throws IOException
    {
        ...
        return new FileInputStream(testUploadSourceDataFile);
    }
