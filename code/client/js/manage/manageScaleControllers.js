...
var scaleMngmtFormEvents = {
    ...
    onScaleUploadSelected: "onScaleUploadSelected",
    onScaleUploadClearSelected: "onScaleUploadClearSelected"
};
...
manageScaleControllers.controller('MngmtScaleUploadCtrl', ['$scope', 'appConfig', 'scaleService', '$timeout',
    function ($scope, appConfig, scaleService, $timeout) {
        ...
        this.onFileUploadChange = function (event) {
            ...
            $scope.$emit(scaleMngmtFormEvents.onScaleUploadSelected, event.target.files);
        };

        $scope.$on(scaleMngmtFormEvents.onScaleUploadClearSelected, function (event) {
...
manageScaleControllers.controller('MngmtScaleUploadManagementCtrl', ['$scope', 'appConfig', 'scaleService', '$timeout',
    function ($scope, appConfig, scaleService, $timeout) {
        this.fileList = {};
        this.isSuccess = false;
        this.errors = [];
        ...
        var uploadScaleCallback = function (data) {
            that.isSuccess = true;
            that.resetErrors();
        };
        ...
        this.uploadScale = function () {
            var fd = new FormData();
            fd.append('file', this.fileList[0]);

            scaleService.uploadScale(fd, uploadScaleCallback, onErrorCallBack);
        };

        this.clearUploadScale = function () {
            this.fileList = {};
            this.setDisabled(true);
            this.resetErrors();
            $scope.$broadcast(scaleMngmtFormEvents.onScaleUploadClearSelected);
        };

        $scope.$on(scaleMngmtFormEvents.onScaleUploadSelected, function (event, fileList) {
