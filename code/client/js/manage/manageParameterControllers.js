...
var parameterMngmtFormEvents = {
    ...
    onParameterUploadSelected: "onParameterUploadSelected",
    onParameterUploadClearSelected: "onParameterUploadClearSelected"
};
...
manageParameterControllers.controller('MngmtParameterUploadCtrl', ['$scope', 'appConfig', 'parameterService', '$timeout',
    function ($scope, appConfig, parameterService, $timeout) {
        ...
        this.onFileUploadChange = function (event) {
            ...
            $scope.$emit(parameterMngmtFormEvents.onParameterUploadSelected, event.target.files);
        };

        $scope.$on(parameterMngmtFormEvents.onParameterUploadClearSelected, function (event) {
...
manageParameterControllers.controller('MngmtParameterUploadManagementCtrl', ['$scope', 'appConfig', 'parameterService', '$timeout',
    function ($scope, appConfig, parameterService, $timeout) {
        this.fileList = {};
        this.isSuccess = false;
        this.errors = [];
        ...
        var uploadParameterCallback = function (data) {
            that.isSuccess = true;
            that.resetErrors();
        };
        ...
        this.uploadParameter = function () {
            var fd = new FormData();
            fd.append('file', this.fileList[0]);

            parameterService.uploadParameter(fd, uploadParameterCallback, onErrorCallBack);
        };

        this.clearUploadParameter = function () {
            this.fileList = {};
            this.setDisabled(true);
            this.resetErrors();
            $scope.$broadcast(parameterMngmtFormEvents.onParameterUploadClearSelected);
        };

        $scope.$on(parameterMngmtFormEvents.onParameterUploadSelected, function (event, fileList) {
