...
# 2. Generate a local build of the AWAG applications for database users
...
def standard_user():
    ...
    configuration_path = os.path.abspath(f'{os.getcwd()}{os.sep}..{os.sep}configuration{os.sep}database')
